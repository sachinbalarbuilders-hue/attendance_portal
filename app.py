...
# Employee database with credentials
EMPLOYEE_DB = {
    "admin@company.com": {
...
def process_attendance_file(file_path, selected_date=None):
    ...
    blank_employees = [
        "Bhavin Patel", "Pramod Dubey", "Shrikant Talekar",
        "Jitendra Patolia", "Lalit Dobariya"
    ]
...
def reset_password():
    ...
    if email in EMPLOYEE_DB and new_password:
        EMPLOYEE_DB[email]["password"] = hashlib.sha256(new_password.encode()).hexdigest()
